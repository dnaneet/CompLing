...
Logicals = ["but", "since", "however", "because", "also", "yet", "therefore", "thereby", "and", "or"]
...
if selection == "Meta-discourse analysis":
  ...
  with st.expander("See explanation"): 
   ...
   st.write("This page allows _you_ to compare the metadiscursive signature of _your_ team's executive summary paragraphs with historic data and cross-genre discourse.")  
