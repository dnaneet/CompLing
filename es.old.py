...
st.sidebar.markdown("##### A large dataset of executive summaries was manually labeled by R.Tewari, Ph.D. and J.E.Johnson, Ph.D.  Data preprocessing was performed by MEEM graduate student, S.Zenner.")
st.sidebar.markdown("##### The metadiscourse analysis dictionary and logic was developed by MEEM undergraduate student, Z.Thelander")
